...
Известно, что у классов ест1ь JSON аннотация, у которой значение property равно имени класса в нижнем регистре.
...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String replace = stringWriter.toString().replaceFirst(oneClassName, resClassName);

        return objectMapper.readValue(new StringReader(replace), resultClassObject);
